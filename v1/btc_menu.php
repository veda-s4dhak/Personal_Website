	...
	<body>
		...
		<div id="main_content" style="background-color: #FFF; z-index: 0; margin: 0 auto; width: 100%;">
			<div id="main_container" style="background-color: #FFF; width: 90%; min-width: 300px; max-width: 1000px; margin: 0 auto;">
				...
				<br>
				<br>
				This is a compliation of information that I have dug up and organized on BitCoin that I think is useful. If you have any questions 
				feel free to email me at <a href="mailto:a22agarw@outlook.com">a22agarw@outlook.com</a><br>
				<br> 

				<div style="text-align: center;">
					<a href="http://anishagarwal.org/btct.php" class="main_img_btn_link">
						<div class="main_img_btn_div" style="height: 234px; padding-top: 10px;">
							<img src="images/bitcoin_term_icon.png" alt="drdc" width="193" height="150" align="middle">
							<div class="main_img_btn_desc_div">
								<p class="main_img_btn_desc"><br>BitCoin Terminology</p>
							</div>
						</div>
					</a>

					<a href="http://anishagarwal.org/btcss.php" class="main_img_btn_link">
						<div class="main_img_btn_div" style="height: 234px; padding-top: 10px;">
							<img src="images/bitcoin_startup_icon.jpg" alt="drdc" width="150" height="150" align="middle">
							<div class="main_img_btn_desc_div">
								<p class="main_img_btn_desc"><br>BitCoin Startups List</p>
							</div>
						</div>
					</a>
				</div>
