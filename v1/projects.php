	...
	<body>
		...
		<div id="main_content" style="background-color: #FFF; z-index: 0; margin: 0 auto; width: 100%;">
			<div id="main_container" style="background-color: #FFF; width: 90%; min-width: 300px; max-width: 1000px; margin: 0 auto;">
				...
				<br><br>
				These are some of the projects that I have worked on in my free time. If you have
				any questions, ideas or want to collaborate please email me at <a href="mailto:a22agarw@outlook.com">a22agarw@outlook.com</a><br>
				<br> 

				<div style="text-align: center;">
					<a href="http://anishagarwal.org/maht.php" class="main_img_btn_link">
						<div class="main_img_btn_div" style="height: 234px; padding-top: 11px;">
							<img src="images/quadrotor_icon.png" alt="drdc" width="200" height="150" align="middle">
							<div class="main_img_btn_desc_div">
								<p class="main_img_btn_desc"><br>FollowCam<br>&nbsp;</p>
							</div>
						</div>
					</a>

					<a href="http://anishagarwal.org/taim.php" class="main_img_btn_link">
						<div class="main_img_btn_div" style="height: 234px; padding-top: 11px;">
							<img src="images/induction_motor_icon.jpg" alt="drdc" width="200" height="150" align="middle">
							<div class="main_img_btn_desc_div">
								<p class="main_img_btn_desc"><br>Two-Phase AC Induction Motor</p>
							</div>
						</div>
					</a>
				</div>
